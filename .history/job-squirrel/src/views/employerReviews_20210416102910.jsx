...
const EmployerReview = () => {
    ...
    return(
        ...
        <div>
            ...
            <div className="box" style={{height:'200px', width:'400px', background:'blue', display:'flex', position:'fixed'}}>
            <div style={{height:'1.5m', width:'1.5em', background:'red', verticalAlign:'center'}}>
            {[1, 2, 3, 4, 5].map((index) => {
          return (
            <RatingIcon 
              index={index} 
